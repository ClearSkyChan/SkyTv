...
{
    public class WxMessageContext : MessageContext<IRequestMessageBase,IResponseMessageBase>
    {
        public WxMessageContext()
        {
        ...
        void CustomMessageContext_MessageContextRemoved(object sender, WeixinContextRemovedEventArgs<IRequestMessageBase,IResponseMessageBase> e)
        {
            ...
            var messageContext = e.MessageContext as WxMessageContext;
